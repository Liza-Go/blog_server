...
var DBConnect_1 = require("./DBConnect"); // Assuming you have a pool instance created in DBConnect
var PostRepository = /** @class */ (function () {
    function PostRepository() {
        this.pool = DBConnect_1.pool;
    }
    PostRepository.prototype.add = function (post) {
    ...
    PostRepository.prototype.update = function (postId, updateData) {
        return __awaiter(this, void 0, void 0, function () {
            var allowedFields, updateFields, query, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        console.error("Error getting post:", error_4);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_5 = _a.sent();
                        console.error("Error getting all posts:", error_5);
                        return [2 /*return*/, []];
                    case 4: return [2 /*return*/];
                }
            });
